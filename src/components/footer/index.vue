<template>
  <footer class="absolute bottom-0 left-0 w-full h-30 flex justify-center items-center bg-violet-400">
    <div class="overflow-x-scroll scroll-x-none md:scroll-x-style md:pb-1.5">
...
export default {
  ...
  data () {
    return {
      items: 'flex flex-col bg-violet-200 rounded p-2 w-24 h-24',
    }
  },
  computed: {
    ...mapGetters([
